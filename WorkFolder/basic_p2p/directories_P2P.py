...
def directory(folder):
    ...
    if current_user == JK:
        if folder == "data":
            return "C:/Users/jakob/Documents/Masteroppgave/IFO25---Project-Thesis/WorkFolder/basic_p2p/data/"
        elif folder == "results":
        ...
        if folder == "data":
            return 'C:/Users/rubab/Desktop/NTNU/Semester/11Semester/TIO4550/KodingIFO25/IFO25---Project-Thesis/WorkFolder/basic_p2p/data/'
        elif folder == "results":
