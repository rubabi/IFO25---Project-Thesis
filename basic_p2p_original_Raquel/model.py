...
# Manual input data
file_path_data = r"/Users/raquelal/PycharmProjects/basic_p2p/data/test_case/" # folder containing data
file_path_results =  r"/Users/raquelal/PycharmProjects/basic_p2p/results/test_case/" # folder containing the results
