...
def directory(folder):
    ...
    if current_user == JK:
        if folder == "Test case":
            return "C:/Users/jakob/Documents/Masteroppgave/IFO25---Project-Thesis/WorkFolder_Svartlamoen/basic_p2p/data/Norwegian case/"
        elif folder == "results":
        ...
        if folder == "Test case":
            return '/Users/olehermanimset/Library/CloudStorage/OneDrive-NTNU/9. Semester/Project Thesis/IFO25---Project-Thesis/WorkFolder_Svartlamoen/basic_p2p/data/Norwegian case/'
        elif folder == "results":
        ...
        if folder == "Test case":
            return 'C:/Users/rubab/Desktop/NTNU/Semester/11Semester/TIO4550/KodingIFO25/IFO25---Project-Thesis/WorkFolder_Svartlamoen/basic_p2p/data/Norwegian case/'
        elif folder == "results":
