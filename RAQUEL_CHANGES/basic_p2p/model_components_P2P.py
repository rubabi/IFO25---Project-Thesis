...
def model_p2p(data):
    ...
    model.p_peak = Param(model.M) # Peak power dependent grid price #RAQUEL
    ...
    model.G_peak = Var(model.M, within=NonNegativeReals)  # Peak power import RAQUEL
    ...
    def peak_power(model, t, m): # Constraint (3) #RAQUEL
